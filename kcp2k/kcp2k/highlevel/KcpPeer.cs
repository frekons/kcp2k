...
namespace kcp2k
{
    ...
    public class KcpPeer
    {
        ...
        public bool DidGetAnyMessageInTime(uint timeInMilliseconds)
        {
            return watch.ElapsedMilliseconds <= lastReceiveTime + timeInMilliseconds;
        }
        ...
        public bool SendData(ArraySegment<byte> data, KcpChannel channel)
        {
